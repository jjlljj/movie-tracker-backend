...
function addFavorite(req, res, next) {
  db.one('insert into favorites(movie_id, user_id, title, poster_path, release_date, vote_average, overview, backdrop_path, favorite)' +
  'values(${movie_id}, ${user_id}, ${title}, ${poster_path}, ${release_date}, ${vote_average}, ${overview}, ${backdrop_path}, ${favorite}) returning id', req.body)
  .then(function(data) {
